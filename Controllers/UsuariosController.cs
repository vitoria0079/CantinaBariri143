...
namespace CantinaBariri143.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuariosId,Nome,CPF,Email,Senha")] Usuarios usuarios)
        {
            if (ModelState.IsValid)
            {
                usuarios.UsuariosId = Guid.NewGuid();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UsuariosId,Nome,CPF,Email,Senha")] Usuarios usuarios)
        {
